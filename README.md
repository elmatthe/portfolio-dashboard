...
**Current version: 0.5.3** · See [`markdown-instructions/CHANGELOG.md`](markdown-instructions/CHANGELOG.md)
for release notes.
...
1. Download `Portfolio Dashboard Setup 0.5.3.exe` from the Releases page.
...
4. Runs `electron-builder --win`, producing
   `release\Portfolio Dashboard Setup 0.5.3.exe` (NSIS, x64, ~196 MB).
