...
**Current version: 0.5.0** · See [`markdown-instructions/CHANGELOG.md`](markdown-instructions/CHANGELOG.md)
for release notes.
...
1. Download `Portfolio Dashboard Setup 0.5.0.exe` from the Releases page.
...
4. Runs `electron-builder --win`, producing
   `release\Portfolio Dashboard Setup 0.5.0.exe` (NSIS, x64, ~196 MB).
